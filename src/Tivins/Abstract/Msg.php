...
class Msg
{
    ...
    static public function set_output(bool $value)
    {
        self::$output = $value;
    }

    static public function set_store_history(bool $value)
    {
        self::$store_history = $value;
    }

    static public function get_history()
    {
        return self::$history;
    }

    static public function reset_history()
    {
        self::$history = [];
    }
