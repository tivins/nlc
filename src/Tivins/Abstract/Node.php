...
class Node
{
    ...
    /**
     * Assign the given Tivins\Abstract\Node next to the current node.
     *
     * @param   $new_next
     ...
     */
    public function set_next(/*?Tivins\Abstract\Node*/ $new_next) /* : ?Token */
    {
        $unlinked = null;
     ...
     * @todo    To create unit test case.
     */
    public function remove_first_child() /* :?Tivins\Abstract\Node */
    {
        // no children, skip.
