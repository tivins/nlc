...
class Token extends Node {
     ...
     *
     * @return int The value of a constant `TYPE_*`, `TYPE_UNKNOWN` if not found.
     */
    ...
    static public function concat_tokens(array $list): string
    {
        $str = '' ;
     ...
     * @return void
     */
    static public function browse(Token &$current, int &$level, array $callbacks = []): void
    {
     ...
     *
     * @return  ?Token Returns the (next|previous)-linear non-code token,
