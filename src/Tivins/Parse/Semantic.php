...
use parse\Java_Schema;
use parse\OProperty;
use parse\While_Loop;
use Tivins\ObjectModel\OClass;
use Tivins\ObjectModel\OEnum;
use Tivins\ObjectModel\OMethod;
use Tivins\ObjectModel\OPackage;
